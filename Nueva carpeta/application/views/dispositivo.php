...
<html lang="es-MX">
    ...
    <body>
        <div class="app" id="app">
            ...
            <!-- content -->
                <div id="content" class="app-content box-shadow-z0" role="main">
                    ...
                    <encabezado titulo="Dispositivos"></encabezado>
                        ...
                        <div class="row">
                                    ...
                                    <div class="box-body">
                                        <form v-on:submit.prevent="onSubmit" v-on:reset.prevent="limpiar" accept-charset="utf-8">
                                            <div class="form-group">
                                                <label>Lugar</label>
                                                <select v-model="dispositivo.lugarid" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label>N&uacute;mero de serie (dispositivo)</label>
                                                <input type="text" v-model="dispositivo.serie" class="form-control">
                                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <div class="box p-a">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div v-if="dispositivos.length <= 0" class="col-xs-12 col-sm-12">
                                                <div class="box p-a">
                                                    <div class="box-body">
                                                        <span class="text-danger"><i class="fa fa-close"></i> No se encontraron dispositivos registrados</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-for="item in dispositivos"  class="col-xs-12 col-sm-3">
                                                <div class="card p-a bg-inverse text-white">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="card-text"> {{ item.serie }} </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <small class="text-muted"> {{ item.lugar }}</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script src="<?= base_url(); ?>js_vue/icomdomotica_dispositivo.js"></script>

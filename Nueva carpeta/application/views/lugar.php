...
<html lang="es-MX">
    ...
    <body>
        <div class="app" id="app">
            <div id="ctrl_lugar">
                ...
                <div id="content" class="app-content box-shadow-z0" role="main">
                    ...
                    <encabezado titulo="Lugares"></encabezado>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="box p-a">
                                        ...
                                        <div class="box-body">
                                            <form v-on:submit.prevent="onSubmit" accept-charset="utf-8">
                                                <div class="form-group">
                                                    <label>Descripci&oacute;n</label>
                                                    <input type="text" v-model="lugar.descripcion" class="form-control">
                                                </div>
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="box p-a">
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div v-if="lugares.length <= 0" class="col-xs-12 col-sm-12">
                                                    <div class="box p-a">
                                                        <div class="box-body">
                                                            <span class="text-danger"><i class="fa fa-close"></i> No se encontraron lugares registrados</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div v-for="item in lugares"  class="col-xs-12 col-sm-4">
                                                    <div class="card bg-info text-white p-a">
                                                        <div class="card-body">
                                                            <div class="card-text text-lg"> <i class="fa fa-home"></i> {{ item.descripcion }} </div>
        ...
        <script src="<?= base_url(); ?>js_vue/icomdomotica_lugar.js"></script>
    </body>
</html>
